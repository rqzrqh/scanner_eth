...
func convertStorageFullBlock(fullblock *protocol.FullBlock) *StorageFullBlock {
...
func convertProtocolFullBlock(fullblock *protocol.FullBlock) *protocol.FullBlock {
