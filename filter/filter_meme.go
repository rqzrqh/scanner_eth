...
func filterTokenLaunched(txHash string, eventLog *eth_types.Log, contractAddr string, height uint64, topic0, topic1, topic2, topic3 string, topicCount int) *data.MemeTokenLaunched {
...
func filterTrade(txHash string, eventLog *eth_types.Log, contractAddr string, height uint64, topic0, topic1, topic2, topic3 string, topicCount int) *data.MemeTrade {
...
func filterLiquiditySwapped(txHash string, eventLog *eth_types.Log, contractAddr string, height uint64, topic0, topic1, topic2, topic3 string, topicCount int) *data.MemeLiquiditySwapped {
	...
	event := &data.MemeLiquiditySwapped{
		Token:         token,
		EthAmount:     eventNonIndexedData.EthAmount.String(),
		TokenAmount:   eventNonIndexedData.TokenAmount.String(),
		VReserveEth:   eventNonIndexedData.VReserveEth.String(),
