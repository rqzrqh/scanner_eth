...
func TestConvertStorageFullBlock(t *testing.T) {
	SetOptionalFeatures(map[string]struct{}{
		model.Tx{}.TableName():                   {},
		model.TxInternal{}.TableName():           {},
		model.EventLog{}.TableName():             {},
	...
	if full.Block == nil || full.Block.IrreversibleHeight != 80 || full.Block.IrreversibleHash != "0x80" {
		t.Fatalf("expected data.Block to carry irreversible ancestor: %+v", full.Block)
	}
